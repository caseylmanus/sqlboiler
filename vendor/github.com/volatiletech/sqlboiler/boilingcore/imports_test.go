...
func TestCombineImports(t *testing.T) {
	...
	a := imports{
		...
		thirdParty: importList{"github.com/caseylmanus/sqlboiler", "gopkg.in/volatiletech/null.v6"},
	}
	b := imports{
		standard:   importList{"os"},
		thirdParty: importList{"github.com/caseylmanus/sqlboiler"},
	}
	...
	if c.thirdParty[0] != "github.com/caseylmanus/sqlboiler" && c.thirdParty[1] != "gopkg.in/volatiletech/null.v6" {
		t.Errorf("Wanted: github.com/caseylmanus/sqlboiler, gopkg.in/volatiletech/null.v6 got: %#v", c.thirdParty)
	}
}
